...
# --- กำหนดช่วงคอลัมน์โครงการ (ขยายให้ครอบคลุมถึง 100) ---
        ...
        if norm_input in global_code_map:
            ...
            for col_idx in range(PROJECT_START_COL, PROJECT_END_COL):
                ...
                if val > 0:
                    ...
                    # กรองเฉพาะชื่อโครงการ (ไม่ใช่ตัวเลขล้วน และยาวไม่เกิน 4 ตัวอักษร/ตัวเลข)
            ...
            # --- ปรับ Logic ช่อง ขาด: ถ้าไม่พอ ให้แสดงจำนวนเดิมที่สั่งมาโดยไม่หักลบ ---
