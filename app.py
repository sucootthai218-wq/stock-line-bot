...
# ID โฟลเดอร์ My Stock บน Google Drive
...
def process_order_and_get_summary(user_msg):
    ...
    # 2. ลบไฟล์ Excel เก่าทิ้งก่อน เพื่อดึงชุดใหม่ล่าสุดจากโฟลเดอร์ My Stock
    ...
    # ดึง 2 ไฟล์ล่าสุดจากโฟลเดอร์ My Stock อัตโนมัติ
    ...
    # ใช้ Pandas อ่านไฟล์แบบโครงสร้างเดิมที่คุณคอนเฟิร์มว่าถูกต้องแม่นยำ
