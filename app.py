...
def get_file_ids_from_folder(creds, folder_id):
...
def process_order_and_get_summary(user_msg):
    ...
    # ดึงไฟล์ใหม่จาก My Stock
    file_ids = get_file_ids_from_folder(creds, DRIVE_FOLDER_ID)
    ...
    for file_path in all_xlsx:
        ...
        df_raw = pd.read_excel(file_path, sheet_name=excel_file_obj.sheet_names[0], header=None, engine='openpyxl')
